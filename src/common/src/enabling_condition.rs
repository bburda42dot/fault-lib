...
mod tests {
    ...
    fn status_all_variants() {
        let statuses = [EnablingConditionStatus::Active, EnablingConditionStatus::Inactive];
        assert_eq!(statuses.len(), 2);
    }

    #[test]
    fn status_equality() {
        assert_eq!(EnablingConditionStatus::Active, EnablingConditionStatus::Active);
        assert_ne!(EnablingConditionStatus::Active, EnablingConditionStatus::Inactive);
    }
